...
set_property PACKAGE_PIN M2 [get_ports {dataout1_p[4]}]
set_property PACKAGE_PIN M6 [get_ports {dataout1_p[3]}]
set_property PACKAGE_PIN N7 [get_ports {dataout1_p[2]}]
set_property PACKAGE_PIN T5 [get_ports {dataout1_p[1]}]
set_property PACKAGE_PIN P6 [get_ports {dataout1_p[0]}]
set_property PACKAGE_PIN T8 [get_ports {dataout2_p[4]}]
set_property PACKAGE_PIN M7 [get_ports {dataout2_p[3]}]
set_property PACKAGE_PIN R7 [get_ports {dataout2_p[1]}]
set_property PACKAGE_PIN U6 [get_ports {dataout2_p[0]}]
set_property PACKAGE_PIN L5 [get_ports {dataout2_p[2]}]
set_property PACKAGE_PIN T4 [get_ports clkout1_p]
